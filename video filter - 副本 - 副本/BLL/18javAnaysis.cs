...
//Rola_Takizawa<br>Vídeo Id: MAS087<br>Sìze: 3.78GB<br><u>Fíles in tørrent:</u> 20 fìles<br>MAS ⁰  ⁸  ⁷ .ISO<br>
        void getHtml(His his,string size)
        {
            ...
            his.Html = "<a href=\"" + torrentUrl + "><img src=\"" + imgUrl + "\"/></a><br><a href=\"https://www.google.com.tw/search?um=1&newwindow=1&safe=off&hl=zh-CN&biw=1362&bih=839&dpr=1&ie=UTF-8&tbm=isch&source=og&sa=N&tab=wi&ei=QKr6U8KMKtOWaqbigogK&q=" + his.Vid + "\"/>"+his.Vid+"</a><br>" + size + "<br>" + "<br>" + his.Actress + "<br>\r\n";
